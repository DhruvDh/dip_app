...
<template>
  <div class="markdown-body container" style="margin-top: 1rem">
    ...
    <ul>
      <li>
        ...
        <ul>
          ...
          <li>
            <a href="#a-quick-review">A quick review</a>
          </li>
          <li>
            <a href="#submission-template-and-rubric">Submission template and Rubric</a>
          </li>
        </ul>
      </li>
    </ul>
    ...
    <p>
      So in this assignment you will be given 3 text files, each with a list of numbers in them - which represent the voltage produced at each pixel location for a CMOS sensor while taking a particular picture. The
      <code>_easy.txt</code> and the
      <code>_medium.txt</code> files represent a 256 by 256 image, while the
      <code>_hard.txt</code> represents a 512 by 512 pixel image. So a list of (256 * 256) voltage values for the
      <code>_easy.txt</code> and
      <code>_medium.txt</code> files, and (512 * 512) values for the
      <code>_hard.txt</code> file.
    </p>
    <p>Each of those “pictures” contain one of three objects - a ball, brick, or cylinder, like so ––</p>
    <p>
      <img
        src="img/ball_brick_cylinder.gif"
        alt="Ball, brick, cylinder"
      >
    </p>
    ...
    <p>
      In the files section, you will find an
      <code>assignment_1_files.zip</code> which will have a bunch of text files. The one’s meant for you will start with your NinerNet username. If your username is
      <code>ddhamani</code>, look for
      <code>ddhamani_easy.txt</code>,
      <code>ddhamani_medium.txt</code>, and
      <code>dhamani_hard.txt</code>
    </p>
    ...
    <ul>
      ...
      <li>
        Each student is assigned a random image - please don’t think that your friends’
        <code>_easy.txt</code> file has a brick in it so yours’ will too. I wrote a script to randomly assign each student a random file.
      </li>
      ...
      <li>
        You will not be graded on whether or not you were able to figure out what was inside the
        <code>_hard.txt</code> file. However if you do manage to do so, you will get some extra credit. Detailed rubric will be included.
      </li>
    ...
    <ul>
      ...
      <li>
        ...
        <ul>
          <li>
            <p>
              Write code to read the list of values you were given in your
              <code>_easy.txt</code>,
              <code>_medium.txt</code>, and
              <code>__hard.txt</code> files.
            </p>
          </li>
          <li>
            <p>
              Try to assign color to 2-4 range of values. For example
              <code>0.2-0.8</code> is light-gray,
              <code>0.8</code> and above is black. As many ranges as you feel appropriate.
            </p>
          </li>
          <li>
            <p>
              Replace each voltage value in the list, with an string containing HTML span of the color for that interval, with a single character inside, for example -
              <code>0.246642</code> according to the above would be
              <code>&lt;span style=&quot;color:gray&quot;&gt;@&lt;/span&gt;</code>. Various gray colors as understood by HTML can be found
              <a
                href="https://www.w3schools.com/colors/colors_shades.asp"
              >here</a>.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              Based on this list, write out an HTML document. Do know that you would have to add a
              <code>&lt;br&gt;</code> tag to insert a new line at the end of every “row” for the image - after every 256 spans for the easy and medium files, and 512 spans for the hard file. Like so ––
            </p>
    ...
    <ul>
      <li>
        <p>
          What object was inside your
          <code>_easy.txt</code> file? (ball, brick, or cylinder) Attach a screenshot of your visualization, and any code you wrote to do the same. [30 points]
        </p>
      </li>
      <li>
        <p>
          What object was inside your
          <code>_medium.txt</code> file? (ball, brick, or cylinder) Attach a screenshot of your visualization, and any code you wrote to do the same. [20 points]
        </p>
      </li>
      <li>
        <p>
          What object was inside your
          <code>_hard.txt</code> file? (ball, brick, or cylinder) Attach a screenshot of your visualization, and any code you wrote to do the same. It is unlikely any of the aforementioned methods would let you guess at what object was in there, to attempt this question you’d hopefully will need to do a little research. [10 extra credits]
        </p>
      </li>
    </ul>
